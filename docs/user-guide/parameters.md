...
| --bakta_locus_tag | Locus tag prefix assigned by NCBI under your BioProject. Required for WGS GenBank submissions; without it the submission may be rejected. | Yes (empty string, or prefix assigned by NCBI) |
