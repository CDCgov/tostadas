...
**TOSTADAS** -- **T**oolkit for **O**pen **S**equence **T**riage, **A**nnotation, and **DA**tabase **S**ubmission
...
- NCBI Submission Guidelines: <https://submit.ncbi.nlm.nih.gov/>
...
- VADR MeV Models (Greninger Lab): <https://github.com/greninger-lab/vadr-models-mev>
