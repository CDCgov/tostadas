...
process LIFTOFF {
    ...
    --ref_gff_path $ref_gff_path --repeatmasker_gff $repeatmasker_gff  --parallel_processes $params.lift_parallel_processes --final_liftoff_output_dir $params.final_liftoff_output_dir \
