...
include { SUBMISSION } from '/scicomp/home-pure/rjd0/tostadas/subworkflows/local/submission.nf'
...
workflow {
    ...
    def input = []
                ...
                input[0] = Channel.of(
                            tuple(    
                                [batch_id: 'batch_1', batch_tsv: file("/scicomp/home-pure/rjd0/tostadas/tests/subworkflows/local/batch_1_mpxv.tsv")], 
                                [ 
    ...
    if (SUBMISSION.output){
        ...
        for (def name in SUBMISSION.out.getNames()) {
            serializeChannel(name, SUBMISSION.out.getProperty(name), jsonOutput)
        }	  
    
        // consumes all unnamed output channels and stores items in a json file
        def array = SUBMISSION.out as Object[]
